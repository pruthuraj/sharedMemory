...
// Constants, shared runtime state, DOM references, and zoom HUD bootstrap.
...
const LOW_SCALE_LABEL_THRESHOLD = 0.5;
...
let nextRpcId = 1;
let graphSettings = (window.Settings && typeof window.Settings.snapshot === 'function') ? window.Settings.snapshot() : {};
